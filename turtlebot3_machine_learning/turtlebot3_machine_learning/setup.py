...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'multi_robot_coordinator = turtlebot3_dqn.multi_robot_coordinator:main',
            'dqn_agent1 = turtlebot3_dqn.dqn_agent1:main',
            'dqn_agent2 = turtlebot3_dqn.dqn_agent2:main',
            'dqn_agent3 = turtlebot3_dqn.dqn_agent3:main',
